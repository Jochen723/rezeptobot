$(document).ready(function(){
    ...
    $.ajax({
        type:'GET',
        url:'db/getRecipeCategories.php',
        dataType: "json",
        data: {
            'rezeptId': 1
        },
        success:function(data){
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                a.href = "kategorieuebersicht.php?q=" + data[i].id;
                ...
                var linkText = document.createTextNode(data[i].kategorie);
                a2.appendChild(linkText);
                a2.href = "kategorieuebersicht.php?q=" + data[i].id;
