$(document).ready(function(){
    ...
    $.ajax({
        type:'GET',
        url:'../backend/getGeplanteRezepte.php',
        dataType: "json",
        data: {
        },
        success:function(data){
            if(!data.success) {
                ...
                data.response.forEach(function (rezept) {
                    ...
                    a.setAttribute('href','../../rezeptdetails/masken/rezeptdetails.php?q='+rezept.rezept_id);
                    ...
                    h3.innerHTML += rezept.titel.link('../../rezeptdetails/masken/rezeptdetails.php?q='+rezept.rezept_id);
                    div2.appendChild(h6);
                    div2.appendChild(a);
                    div2.appendChild(h3);
